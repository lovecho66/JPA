[2장 JPA 시작](#2--jpa---)
* [2.1 이클립스 설치와 프로젝트 불러오기](#21-------------------)
  + [서론](#--)
  + [이클립스 설치와 프로젝트 불러오기](#------------------)
    - [예제 프로젝트 불러오기](#------------)
    - [메이븐 오류 해결](#---------)
* [2.2 H2 데이터 베이스 설치](#22-h2-----------)
  + [서론](#---1)
    - [H2 데이터베이스 설치 방법](#h2-------------)
    - [예제 테이블 생성](#---------)
* [2.3 라이브러리와 프로젝트 구조](#23---------------)
  + [서론](#---2)
  + [2.3.1 메이븐과 사용 라이브러리 관리](#231-----------------)
* [2.4 객체 매핑 시작](#24---------)
  + [회원 테이블 생성](#---------)
  + [회원 클래스 생성](#---------)
  + [매핑 작업](#-----)
  + [매핑 정보가 포함된 회원 클래스](#-----------------)
    ...
    - [@Column](#-column)
    - [@매핑 정보가 없는 필드](#-------------)
* [2.5 persistence.xml 설정](#25-persistencexml---)
  + [서론](#---3)
  + [2.5.1 데이터베이스 방언](#251----------)
* [2.6 애플리케이션 개발](#26----------)
  + [서론](#---4)
  + [2.6.1 엔티티 매니저 설정](#261-----------)
    - [엔티티 매니저 팩토리 생성](#--------------)
    - [엔티티 매니저 생성](#----------)
    - [종료](#--)
  + [2.6.2 트랜잭션 관리](#262--------)
